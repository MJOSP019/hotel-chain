...
{
    /// <inheritdoc />
    public partial class AddSearchAudits : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MinRating = table.Column<double>(type: "float", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SearchAudits_Cities_CityId",
                        column: x => x.CityId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SearchAudits_CityId",
                table: "SearchAudits",
                column: "CityId");

            migrationBuilder.CreateIndex(
                name: "IX_SearchAudits_CreatedAt",
                table: "SearchAudits",
                column: "CreatedAt");
